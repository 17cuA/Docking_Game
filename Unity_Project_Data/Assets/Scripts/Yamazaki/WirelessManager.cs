...
public class WirelessManager : MonoBehaviour
{
	...
	private WirelessString[] wirelessList = new WirelessString[33]
	{
		...
		// ドッキング成功時無線字幕
		new WirelessString("パイロット「ドッキング成功」"),
		new WirelessString("ー管制室に響き渡る歓声ー"),
		new WirelessString("パイロット「これよりフェイズ３へ移行する」"),
		new WirelessString("ＨＱ「難しい軌道だったがよくやってくれた」"),
		new WirelessString("パイロット「妻の機嫌を取るほうがよっぽど難しいさ」"),
		// ドッキング失敗時無線字幕
		new WirelessString("パイロット「ドッキング失敗、未確認物体から高エネルギー反応を感知」"),
